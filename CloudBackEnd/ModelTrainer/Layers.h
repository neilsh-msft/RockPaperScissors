...
namespace CntkTraining
{
	...
	public:
		...
		static CNTK::FunctionPtr LSTM(CNTK::Variable input, size_t numOutputClasses, size_t hiddenDim, size_t cellDim, size_t lstmCells, 
			const CNTK::DeviceDescriptor& device = CNTK::DeviceDescriptor::UseDefaultDevice());
	...
	protected:
		static std::pair<CNTK::FunctionPtr, CNTK::FunctionPtr> LSTMPComponentWithSelfStabilization(CNTK::Variable input, const CNTK::NDShape& outputShape, const CNTK::NDShape& cellShape,
			...
			const CNTK::DeviceDescriptor& device = CNTK::DeviceDescriptor::UseDefaultDevice());
		static std::pair<CNTK::FunctionPtr, CNTK::FunctionPtr> LSTMPCellWithSelfStabilization(CNTK::Variable input, CNTK::Variable prevOutput, CNTK::Variable prevCellState,
			const CNTK::DeviceDescriptor& device = CNTK::DeviceDescriptor::UseDefaultDevice());
